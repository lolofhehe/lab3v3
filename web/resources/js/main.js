...
function paint(r = null) {
    ...
    context.arc(centerX, centerY, pointDistance, 0, Math.PI * 3/2, true);
    context.moveTo(centerX, centerY);
    ...
    let [left, bottom] = convertCleanToCanvasCoordinates(-5, -3, radius, centerX, centerY, pointDistance);
    let [right, top] = convertCleanToCanvasCoordinates(5, 5, radius, centerX, centerY, pointDistance);
